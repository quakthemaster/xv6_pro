...
int main(void)
{
  ...
  18:	e8 a3 03 00 00       	call   3c0 <printf>
	...
	a = random();
  1d:	e8 c8 02 00 00       	call   2ea <random>
	printf(1,"%d\n",a);
  22:	c7 44 24 04 48 07 00 	movl   $0x748,0x4(%esp)
  29:	00 
...
SYSCALL(random)  // This is the system call that we are adding for XOR_SHIFT
 2ea:	b8 16 00 00 00       	mov    $0x16,%eax
 2ef:	cd 40                	int    $0x40
 2f1:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 359:	0f b6 92 53 07 00 00 	movzbl 0x753(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4ef:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 4f1:	b8 4c 07 00 00       	mov    $0x74c,%eax
...
free(void *ap)
{
 ...
 5f7:	89 10                	mov    %edx,(%eax)
  freep = p;
 5f9:	a3 cc 09 00 00       	mov    %eax,0x9cc
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 622:	a3 cc 09 00 00       	mov    %eax,0x9cc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 1d cc 09 00 00    	mov    0x9cc,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 689:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 68b:	3b 15 cc 09 00 00    	cmp    0x9cc,%edx
...
morecore(uint nu)
{
 ...
 6aa:	e8 43 fc ff ff       	call   2f2 <sbrk>
  if(p == (char*)-1)
 ...
 6bd:	e8 ee fe ff ff       	call   5b0 <free>
  return freep;
 6c2:	8b 15 cc 09 00 00    	mov    0x9cc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6e4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6e7:	89 15 cc 09 00 00    	mov    %edx,0x9cc
      return (void*)(p + 1);
 ...
 6fc:	eb e9                	jmp    6e7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fe:	c7 05 cc 09 00 00 d0 	movl   $0x9d0,0x9cc
 705:	09 00 00 
    base.s.size = 0;
 708:	ba d0 09 00 00       	mov    $0x9d0,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 70d:	c7 05 d0 09 00 00 d0 	movl   $0x9d0,0x9d0
 714:	09 00 00 
    base.s.size = 0;
 717:	c7 05 d4 09 00 00 00 	movl   $0x0,0x9d4
 71e:	00 00 00 
