...
int main(void)
{
  ...
  1d:	e8 c8 02 00 00       	call   2ea <random>
	printf(1,"%d\n",a);
  22:	c7 44 24 04 38 07 00 	movl   $0x738,0x4(%esp)
  29:	00 
  2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  31:	89 44 24 08          	mov    %eax,0x8(%esp)
  35:	e8 76 03 00 00       	call   3b0 <printf>
	return(0);
}
...
free(void *ap)
{
 ...
 60f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 612:	a3 bc 09 00 00       	mov    %eax,0x9bc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 1d bc 09 00 00    	mov    0x9bc,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 679:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 67b:	3b 15 bc 09 00 00    	cmp    0x9bc,%edx
...
morecore(uint nu)
{
 ...
 69a:	e8 53 fc ff ff       	call   2f2 <sbrk>
  if(p == (char*)-1)
 ...
 6ad:	e8 ee fe ff ff       	call   5a0 <free>
  return freep;
 6b2:	8b 15 bc 09 00 00    	mov    0x9bc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6d4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6d7:	89 15 bc 09 00 00    	mov    %edx,0x9bc
      return (void*)(p + 1);
 ...
 6ec:	eb e9                	jmp    6d7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6ee:	c7 05 bc 09 00 00 c0 	movl   $0x9c0,0x9bc
 6f5:	09 00 00 
    base.s.size = 0;
 6f8:	ba c0 09 00 00       	mov    $0x9c0,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fd:	c7 05 c0 09 00 00 c0 	movl   $0x9c0,0x9c0
 704:	09 00 00 
    base.s.size = 0;
 707:	c7 05 c4 09 00 00 00 	movl   $0x0,0x9c4
 70e:	00 00 00 
