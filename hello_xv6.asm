...
void hello_xv6(int argc ,char *argv[]){
   ...
   c:	c7 44 24 04 16 07 00 	movl   $0x716,0x4(%esp)
  13:	00 
  14:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  1b:	89 44 24 08          	mov    %eax,0x8(%esp)
  1f:	e8 8c 03 00 00       	call   3b0 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 349:	0f b6 92 3b 07 00 00 	movzbl 0x73b(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4df:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 4e1:	b8 34 07 00 00       	mov    $0x734,%eax
