...
void sanidhya(void){
   ...
   6:	c7 44 24 04 d0 06 00 	movl   $0x6d0,0x4(%esp)
   d:	00 
   e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  15:	e8 96 03 00 00       	call   3b0 <printf>
}
  1a:	c9                   	leave  
  1b:	c3                   	ret    
  1c:	66 90                	xchg   %ax,%ax
...
00000310 <printint>:
 ...
 34f:	f7 f6                	div    %esi
 351:	0f b6 92 f0 06 00 00 	movzbl 0x6f0(%edx),%edx
...
000003b0 <printf>:
 ...
 4cb:	b8 e8 06 00 00       	mov    $0x6e8,%eax
...
00000550 <free>:
 550:	55                   	push   %ebp
 551:	a1 84 09 00 00       	mov    0x984,%eax
 ...
 5a9:	a3 84 09 00 00       	mov    %eax,0x984
 5ae:	5b                   	pop    %ebx
 5af:	5e                   	pop    %esi
 5b0:	5f                   	pop    %edi
 5b1:	5d                   	pop    %ebp
 ...
 5cd:	a3 84 09 00 00       	mov    %eax,0x984
...
000005e0 <malloc>:
 ...
 5ec:	8b 15 84 09 00 00    	mov    0x984,%edx
 ...
 641:	39 05 84 09 00 00    	cmp    %eax,0x984
 ...
 66b:	8b 15 84 09 00 00    	mov    0x984,%edx
 ...
 68f:	89 15 84 09 00 00    	mov    %edx,0x984
 ...
 6a6:	c7 05 84 09 00 00 88 	movl   $0x988,0x984
 6ad:	09 00 00 
 6b0:	c7 05 88 09 00 00 88 	movl   $0x988,0x988
 6b7:	09 00 00 
 6ba:	b8 88 09 00 00       	mov    $0x988,%eax
 6bf:	c7 05 8c 09 00 00 00 	movl   $0x0,0x98c
 6c6:	00 00 00 
