...
_chng_length:     file format elf32-i386
...
{		
  ...
  4a:	c7 44 24 04 7e 07 00 	movl   $0x77e,0x4(%esp)
  51:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 399:	0f b6 92 9d 07 00 00 	movzbl 0x79d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 52f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 531:	b8 96 07 00 00       	mov    $0x796,%eax
