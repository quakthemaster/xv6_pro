...
int main(int argc, char *argv[])
{
  ...
  38:	8b 43 10             	mov    0x10(%ebx),%eax
  3b:	89 04 24             	mov    %eax,(%esp)
  3e:	e8 3d 02 00 00       	call   280 <atoi>
  43:	89 44 24 2c          	mov    %eax,0x2c(%esp)
	maxnum_process = atoi(argv[5]);
  47:	8b 43 14             	mov    0x14(%ebx),%eax
  4a:	89 04 24             	mov    %eax,(%esp)
  4d:	e8 2e 02 00 00       	call   280 <atoi>
...
int nextprocessbirthtime(int a, int b ){
	...
	uint8_t rand;
	rand = random();
  54:	e8 11 03 00 00       	call   36a <random>
  59:	e8 0c 03 00 00       	call   36a <random>
	minp_runtime = atoi(argv[3]);
	maxp_runtime = atoi(argv[4]);
	maxnum_process = atoi(argv[5]);
  ...
  5e:	8b 4c 24 2c          	mov    0x2c(%esp),%ecx
  62:	8b 54 24 28          	mov    0x28(%esp),%edx
  66:	89 7c 24 20          	mov    %edi,0x20(%esp)
  6a:	89 74 24 1c          	mov    %esi,0x1c(%esp)
  6e:	89 4c 24 14          	mov    %ecx,0x14(%esp)
  72:	89 54 24 0c          	mov    %edx,0xc(%esp)
  76:	89 5c 24 18          	mov    %ebx,0x18(%esp)
  7a:	89 7c 24 10          	mov    %edi,0x10(%esp)
  7e:	89 74 24 08          	mov    %esi,0x8(%esp)
  82:	c7 44 24 04 a6 07 00 	movl   $0x7a6,0x4(%esp)
  89:	00 
  8a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  91:	e8 aa 03 00 00       	call   440 <printf>
...
int nextprocessbirthtime(int a, int b ){
  ...
  a3:	83 ec 08             	sub    $0x8,%esp
	...
	uint8_t rand;
	rand = random();
  a6:	e8 bf 02 00 00       	call   36a <random>
...
int processruntime(int a , int b){
  ...
  b3:	83 ec 08             	sub    $0x8,%esp
	...
	uint8_t rand;
	rand = random();
  b6:	e8 af 02 00 00       	call   36a <random>
	sc_rand = (rand/256)*(b-a) ;
	sc_rand1 = a + sc_rand;
	return(sc_rand1);
}
...
free(void *ap)
{
 ...
 677:	89 10                	mov    %edx,(%eax)
  freep = p;
 679:	a3 7c 0a 00 00       	mov    %eax,0xa7c
}
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
 ...
 69f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 6a2:	a3 7c 0a 00 00       	mov    %eax,0xa7c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 1d 7c 0a 00 00    	mov    0xa7c,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 709:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 70b:	3b 15 7c 0a 00 00    	cmp    0xa7c,%edx
...
morecore(uint nu)
{
 ...
 72a:	e8 43 fc ff ff       	call   372 <sbrk>
  if(p == (char*)-1)
 ...
 73d:	e8 ee fe ff ff       	call   630 <free>
  return freep;
 742:	8b 15 7c 0a 00 00    	mov    0xa7c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 77c:	eb e9                	jmp    767 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 77e:	c7 05 7c 0a 00 00 80 	movl   $0xa80,0xa7c
 785:	0a 00 00 
    base.s.size = 0;
 788:	ba 80 0a 00 00       	mov    $0xa80,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 78d:	c7 05 80 0a 00 00 80 	movl   $0xa80,0xa80
 794:	0a 00 00 
    base.s.size = 0;
 797:	c7 05 84 0a 00 00 00 	movl   $0x0,0xa84
 79e:	00 00 00 
