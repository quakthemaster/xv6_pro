...
_chng_priorty:     file format elf32-i386
...
{		
  ...
  14:	c7 44 24 04 66 07 00 	movl   $0x766,0x4(%esp)
  1b:	00 
  1c:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  23:	e8 d8 03 00 00       	call   400 <printf>
      exit();
  28:	e8 75 02 00 00       	call   2a2 <exit>
  }
  pid = atoi ( argv[1] );
  ...
  4a:	c7 44 24 04 80 07 00 	movl   $0x780,0x4(%esp)
  51:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 399:	0f b6 92 a1 07 00 00 	movzbl 0x7a1(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 52f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 531:	b8 9a 07 00 00       	mov    $0x79a,%eax
...
free(void *ap)
{
 ...
 637:	89 10                	mov    %edx,(%eax)
  freep = p;
 639:	a3 1c 0a 00 00       	mov    %eax,0xa1c
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 662:	a3 1c 0a 00 00       	mov    %eax,0xa1c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 1d 1c 0a 00 00    	mov    0xa1c,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6c9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6cb:	3b 15 1c 0a 00 00    	cmp    0xa1c,%edx
...
morecore(uint nu)
{
 ...
 6fd:	e8 ee fe ff ff       	call   5f0 <free>
  return freep;
 702:	8b 15 1c 0a 00 00    	mov    0xa1c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 724:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 727:	89 15 1c 0a 00 00    	mov    %edx,0xa1c
      return (void*)(p + 1);
 ...
 73c:	eb e9                	jmp    727 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 73e:	c7 05 1c 0a 00 00 20 	movl   $0xa20,0xa1c
 745:	0a 00 00 
    base.s.size = 0;
 748:	ba 20 0a 00 00       	mov    $0xa20,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 74d:	c7 05 20 0a 00 00 20 	movl   $0xa20,0xa20
 754:	0a 00 00 
    base.s.size = 0;
 757:	c7 05 24 0a 00 00 00 	movl   $0x0,0xa24
 75e:	00 00 00 
